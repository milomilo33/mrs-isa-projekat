...
<div class="my-form">
   <div class="card-header">Appointment history</div>
            <b-alert v-model="showFailedAlert" dismissible fade variant="danger">
                No medical report available for given appointment!
            </b-alert>
            <b-alert v-model="showNoAppointment" dismissible fade variant="danger">
            ...
            <div v-if="Object.keys(medicalReport.medicineQuantity).length > 0" class="d-block text-center">
                <h3>Prescribed medicines</h3>
                <b-list-group>
                    <b-list-group-item v-for="(quantity, name) in medicalReport.medicineQuantity" :key="name"
              ...
              <b-col lg="4" class="my-1">
               ...
               <b-col lg="8" class="my-1">
                <b-form-group
                  ...
                  label-size="sm"
                  class="mb-0">
                  <b-button variant="success" @click="getMedicalReport()">
                      View medical report
                  </b-button>
                </b-form-group>
              </b-col>
